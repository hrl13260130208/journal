...
class name_manager:
    def create_website_journal_set_name(self,website):
        ...
        :return:
        '''
        return website.strip()+"_journals_set"
    ...
    def create_journal_common_info_name(self,journal):
        ...
        :return:
        '''
        return  journal.strip()+"_common_info"
    ...
    def create_download_schedule_name(self,journal):
        ...
        :return:
        '''
        return journal.strip()+"_download_schedule_set"
    ...
    def create_journal_temp_data_name(self,journal):
        ...
        :return:
        '''
        return  journal.strip()+"_temp_data"
    ...
    def create_article_data_name(self,website):
        ...
        :return:
        '''
        return  website.strip()+"_article_data_list"
    ...
    def create_discontinue_journal_name(self):
        '''
    ...
    def create_download_article_data_name(self,journal,volume,issue):
        '''
        创建存储文章数据的set的名称
        :param journal:
        :param volume:
        ...
        :return:
        '''
        return journal.strip()+"_"+volume.strip()+"_"+issue.strip()


    def save_download_article_data(self,journal,volume,issue,data):
        '''
        按卷期存储文章信息
        :param journal:
        :param volume:
        ...
        :return:
        '''
        redis_.sadd(self.create_download_article_data_name(journal,volume,issue),data)

    def get_download_article_data(self,journal,volume,issue):
        '''
        按卷期查询下载数据
        :param journal:
        :param volume:
        ...
        :return:
        '''
        return redis_.smembers(self.create_download_article_data_name(journal,volume,issue))
    ...
    def save_download_schedule(self, journal, volume, issue):
        ...
        :return:
        '''
        return  redis_.sadd(self.create_download_schedule_name(journal), volume.strip() + "_" + issue.strip())
    ...
    def is_discontinue_journal(self,url):
        ...
        :return:
        '''
        return  redis_.sismember(self.create_discontinue_journal_name(),url)
    ...
    def save_discontiune_journal(self,url):
        ...
        :return:
        '''
        redis_.sadd(self.create_discontinue_journal_name(),url)
...
def get_journal_volumes(journal_title,volume,issue):
    """
    获取指定期刊的指定卷期下数据
    :return:
    """
    ...
    volume=str(volume)
    issue=str(issue)
    infos=nm.get_download_article_data(journal_title,volume,issue)
    print(journal_title+"\t"+volume+"卷\t"+issue+"期：")
    for info in infos:
        print(info)
...
if __name__ == '__main__':
    ...
    for key in redis_.keys("*"):
        ...
        if redis_.type(key) == "string":
            ...
            print(key," : ",redis_.scard(key)," : ",redis_.srandmember(key,10))#redis_.smembers(key)
        elif redis_.type(key) =="list":
            print(key ," : ",redis_.llen(key)," : ",redis_.lindex(key,0) )#redis_.lrange(key,0,100))
        # redis_.delete(key)
    # delete_downloads()
    #
    #
    # website_info("N-OMICS")
    # delete_website("N-OMICS")

    # get_journal_volumes("","","")
    # for key in redis_.keys("Eurosurveillance*"):
    #     print(key)
    # print(sorted(redis_.smembers("Eurosurveillance_download_schedule_set")))
